...
impl <'i>Procedure<'i> {
    pub fn eval(self, env_table: &mut EnvTable<'i>, parent_env: Env, args: LinkedList<Expr<'i>>) -> Result<Expr<'i>> {
...
impl Builtin {
    pub fn eval<'i>(&self, env_table: &mut EnvTable<'i>, env: Env, args: LinkedList<Expr<'i>>) -> Result<Expr<'i>> {
        match self {
    ...
    pub fn define<'i>(&self, env_table: &mut EnvTable<'i>, env: Env, mut args: LinkedList<Expr<'i>>) -> Result<Expr<'i>> {
        let symbol = 
            args
            .pop_front()
            .ok_or(Error::IncorrectArgCount)
    ...
    pub fn ifelse<'i>(&self, env_table: &mut EnvTable<'i>, env: Env, mut args: LinkedList<Expr<'i>>) -> Result<Expr<'i>> {
        let cond =
            args
            .pop_front()
            .ok_or(Error::IncorrectArgCount)?
        ...
        Ok(if cond { exp1.eval(env_table, env)? } else { exp2.eval(env_table, env)? })
    }

    pub fn leq<'i>(&self, env_table: &mut EnvTable<'i>, env: Env, mut args: LinkedList<Expr<'i>>) -> Result<Expr<'i>> {
        let a =
            args
            .pop_front()
            .ok_or(Error::IncorrectArgCount)?
    ...
    pub fn add<'i>(&self, env_table: &mut EnvTable<'i>, env: Env, mut args: LinkedList<Expr<'i>>) -> Result<Expr<'i>> {
        let a =
            args
            .pop_front()
            .ok_or(Error::IncorrectArgCount)?
    ...
    pub fn sub<'i>(&self, env_table: &mut EnvTable<'i>, env: Env, mut args: LinkedList<Expr<'i>>) -> Result<Expr<'i>> {
        let a =
            args
            .pop_front()
            .ok_or(Error::IncorrectArgCount)?
    ...
    pub fn mul<'i>(&self, env_table: &mut EnvTable<'i>, env: Env, mut args: LinkedList<Expr<'i>>) -> Result<Expr<'i>> {
        let a =
            args
            .pop_front()
            .ok_or(Error::IncorrectArgCount)?
    ...
    pub fn div<'i>(&self, env_table: &mut EnvTable<'i>, env: Env, mut args: LinkedList<Expr<'i>>) -> Result<Expr<'i>> {
        let a =
            args
            .pop_front()
            .ok_or(Error::IncorrectArgCount)?
